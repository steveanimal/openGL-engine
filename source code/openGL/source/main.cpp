...
int main() {
    ...
    gl::player player(gl::camera(glm::vec3(0.0f, 0.0f, 0.0f), glm::vec3(0.0f, 0.0f, 0.0f), glm::vec3(0.0f, 1.0f, 0.0f)), shader);
    ...
    while (window.run()) {
        ...
        awp.draw(shader.getProgram(), gl::getItemOffset(player.getCam()), glm::vec3(1.0f), gl::getItemRotation(player.getCam()));
